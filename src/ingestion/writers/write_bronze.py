...
def write_bronze_to_s3(
    ...
    """
    """
    fetched_at_dt = _utc_now()
    fetched_at = _iso(fetched_at_dt)
    ...
    envelope = {
        "meta": {
            ...
            "run_id": _run_partition(fetched_at_dt),
            "dt": _dt_partition(fetched_at_dt),
